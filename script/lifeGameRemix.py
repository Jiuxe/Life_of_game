...
while True:
    ...
    for y in range(0,nxC):
        for x in range(0,nyC):
            ...
            if gameState[x,y] == 2 or gameState[x,y] == 4:
                n_neigh_good = 0
                n_neigh_bad = 0
                n_neigh_killer = 0
                for i in range(-1,1):
                    for j in range(-1,1):
                        if gameState[(x + i) % nxC, (y + j) % nyC] == 2:
                            n_neigh_good += 1
            ...
            if gameState[x, y] == 1 and n_neigh == 5:
                newGameState[x, y] = random.choice([2, 4])

            # Regla 4: Una celula buena vecina de 2 o mas celulas malas, muere
            if gameState[x, y] == 2 and n_neigh_bad > 2:
                newGameState[x, y] = 0
            ...
            if (gameState[x,y] == 2 or gameState[x,y] == 4) and n_neigh_killer != 0:
                newGameState[x, y] = 0
